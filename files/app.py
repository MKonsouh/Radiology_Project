...
def main():
    ...
    img_width = st.sidebar.number_input("Image Width", value=224, min_value=32, max_value=1024)
    img_height = st.sidebar.number_input("Image Height", value=224, min_value=32, max_value=1024)
